...
<head>
    ...
    <title>Life must respect each other | Home Green</title>
    <meta content="" name="description">
    <meta content="" name="keywords">

    <!-- Favicons -->
    <link href="{{ asset('assets/img/wepik--20230731023621KYrK.png') }}" rel="icon">
...
<body>
    <!--- Modal Register------>
    <div class="modal fade border-0" id="modalregister" data-bs-backdrop="static" data-bs-keyboard="false"
        tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" style="border: 0px">
            <div class="modal-content border-0 shadow-lg" style="backdrop-filter: blur(5px); background: #eaff0538">
                ...
                <div class="modal-body border-0">
                    <form action="/register" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control border-white bg-transparent text-white"
                                name="name">
                        </div>
                        <div class="mb-3">
                            <label class="form-label text-white fw-bold">Email address</label>
                            <input type="email" class="form-control border-white bg-transparent text-white"
                                id="exampleInputEmail1" aria-describedby="emailHelp" name="email">
                        </div>
                        <div class="mb-3">
                            <label class="form-label text-white fw-bold">Password</label>
                            <input type="password" class="form-control border-white bg-transparent text-white fw-bold"
                                id="exampleInputPassword1" name="password" name="password">
                        </div>
                        <div class="mb-3">
                            <a href="#" data-bs-toggle="modal" data-bs-target="#staticBackdrop"
                                class="text-white text-decoration-none">registration? here...</a>
                        </div>
                </div>
    ...
    <!--- end Modal Register------>
    <!--- Modal------>
    <div class="modal fade border-0" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false"
        tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" style="border: 0px">
            <div class="modal-content border-0 shadow-lg" style="backdrop-filter: blur(5px); background: #eaff0538">
                <div class="modal-header border-0">
                ...
                <div class="modal-body border-0">
                    <form action="/login_actions" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label class="form-label text-white fw-bold">Email address</label>
                            <input type="email" class="form-control border-white bg-transparent text-white"
                ...
                <div class="modal-footer border-0">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-warning text-white">Sign in</button>
                </div>
                </form>
            </div>
        </div>
    ...
    <header id="header" class="fixed-top ">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo me-auto"><a href="/">H<span class="fs-6">ome</span> G<span
                        class="fs-6">reen</span> </a></h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1"
                    ...
                    <h1>Better Solutions For Your Plants</h1>
                    <h2>this is a webstie of shelter, sale, and planting.</h2>
                    <div class="d-flex justify-content-center justify-content-lg-start">
                        <a href="#about" class="btn-get-started scrollto">Get Started</a>
                        <a href="https://youtu.be/48NFdka7aB4" class="glightbox btn-watch-video"><i
                                class="bi bi-play-circle"></i><span>Watch Video</span></a>
                    </div>
                </div>
                <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
                    <img src="{{ asset('assets/img/wepik--20230731025458gY02.png') }}" class="img-fluid animated"
                        alt="">
                </div>
            </div>
        </div>
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    @foreach ($front as $item)
                        <div class="col-lg-4 col-md-6 portfolio-item">
                            <div class="portfolio-img"><img src="{{ asset('imageFile/' . $item->image) }}"
                                    class="img-fluid" alt=""></div>
                            <div class="portfolio-info">
                                <h4>{{ $item->name }}</h4>
                                <p>Status ? {{ $item->availability }}</p>
                                <a href="{{ asset('imageFile/' . $item->image) }}" data-gallery="portfolioGallery"
                    ...
                    @endforeach
                @else
                    <img width="500px" src="{{ asset('assets/errors/no-product.png') }}" alt=""
                        srcset="" class="img-fluid animated">
                    @endif
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="100">
                        <div class="member d-flex align-items-start">
                            <div class="pic"><img src="{{ asset('assets/Front/assets/img/team/team-1.jpg') }}"
                                    class="img-fluid" alt=""></div>
                    ...
                    <div class="col-lg-6 mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="200">
                        <div class="member d-flex align-items-start">
                            <div class="pic"><img src="{{ asset('assets/img/pp.png') }}" class="img-fluid"
                                    alt=""></div>
                            <div class="member-info">
                                <h4>Fikri Nurhakim</h4>
                    ...
                    <div class="col-lg-6 mt-4" data-aos="zoom-in" data-aos-delay="300">
                        <div class="member d-flex align-items-start">
                            <div class="pic"><img src="{{ asset('assets/Front/assets/img/team/team-3.jpg') }}"
                                    class="img-fluid" alt=""></div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-6 mt-4" data-aos="zoom-in" data-aos-delay="400">
                        <div class="member d-flex align-items-start">
                            <div class="pic"><img src="{{ asset('assets/Front/assets/img/team/team-4.jpg') }}"
                                    class="img-fluid" alt=""></div>
                            <div class="member-info">
                                <h4>Amanda Jepsons</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="200">
                        <div class="box featured">
                            ...
                            <h4><sup>$</sup>30<span>per month</span></h4>
                            <ul>
                                <li><i class="bx bx-check"></i> Quam adipiscing vitae proin</li>
                                <li><i class="bx bx-check"></i> Nec feugiat nisl pretium</li>
                                <li><i class="bx bx-check"></i> Nulla at volutpat diam uteera</li>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
                        <form action="{{ asset('assets/Front/forms/contact.php') }}" method="post" role="form"
    ...
    <footer id="footer">
        ...
        <div class="container footer-bottom clearfix">
            ...
            <div class="credits">
                ...
                Designed by <a href="https://bootstrapmade.com/">Fikri Nurhakim</a>
            </div>
        </div>
    </footer><!-- End Footer -->
